...
Source: New_MCMT (best identity management logic).

Key advantage over Updated_AI_Engine version:
  ...
  - Dual-strategy matching in main.py (FAISS fast + DB robust) uses this.
...
class GlobalIdentityDatabase:
    ...
    def register_new_identity(
        ...
        Args:
            ...
            track_id:   Local track ID (str after normalisation in main.py).
    ...
    def find_match(
        ...
        This is the robust complement to FAISS matching (strategy 2 in main.py).
    ...
    def get_global_id_for_track(self, camera_id: int, track_id) -> int:
        ...
        Args:
            track_id: Must be a str (normalised in main.py with str()).
